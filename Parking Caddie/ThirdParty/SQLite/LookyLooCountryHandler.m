...
#import "LookyLooCountryHandler.h"

@implementation LookyLooCountryHandler
...
- (NSMutableArray *)fetchCityListData:(NSString *)queryString {
	...
	return [getListArray autorelease];
}
...
- (NSMutableArray *)FetchCountry
{
    ...
    return [countryArray autorelease];
}
